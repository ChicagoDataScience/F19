...
#### 09/26 : Recurrent Neural Networks and Transformers: Sequence to Sequence Learning, RNNs and LSTMs, Attention and BERT
 ...
 - [Transformer in Pytorch](https://pytorch.org/docs/stable/_modules/torch/nn/modules/transformer.html)
...
There is a group project component to this course. Additional details are provided [here](https://chicagodatascience.github.io/f19/576/project_instructions.pdf). <span style="color:red;"> An intermediate check point (to hand in a 1-page proposal in class) is 10/17</span>. The final deadline to submit is 11/27.
